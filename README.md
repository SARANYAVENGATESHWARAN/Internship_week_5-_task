...
### Week 5 – Internship Task (Advanced CSS & Modern Layouts)

## 📌 Project Overview

This project is a responsive personal portfolio website developed using **HTML, CSS, and JavaScript** as part of the **Week-5 Internship Task**. The primary objective of this project is to demonstrate the practical use of **advanced CSS concepts**, modern layout techniques, and professional front-end structuring practices.
...
* Apply maintainable and scalable CSS architecture
* Build a responsive, performance-optimized UI
...
* **CSS3** – Grid, Flexbox, Variables, Animations, Advanced Selectors
...
* **CSS Variables** implemented for centralized theming and spacing
* **Animations & Transitions** added for smooth UI interactions
...
The project was tested manually to ensure functionality and responsiveness.

**Testing Performed:**

* Page load and layout rendering
* Responsive behavior on mobile and desktop
* Navigation and interaction validation
* Hover and animation behavior
